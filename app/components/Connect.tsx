    ...
    <div>
        ...
        <Image src={StarIcon} alt="star" width={20} height={20} className="absolute top-1000 left-220" /> */}
            ...
            <div className='p-5 md:p-0'>
                ...
                <button type='submit' className={`${openSans.className} border rounded-sm text-[#2E2B28] px-8 py-2 mt-7 cursor-pointer hover:bg-[#2E2B28] hover:text-[#FFFFFF] transition-all duration-300`}>SEND</button>
            </div>
            </div>
        </div>
    </div>
