    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start md:mt-13">
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          >
            Visit our private studio or schedule a digital consultation. Our specialists are here to assist with gemstone
            selection, customization, and personal styling.
          </p>

          {/* Location */}
          <div className="text-md text-[#2E2B28] space-y-1 mb-6" style={{ fontFamily: "Inter" }}>
            ...
            <p>Diamantclub Van</p>
            <p>Antwerpen, Office #1019–1020 , Antwerpen, 2018,</p>
            <p>Belgium VAT:</p>
            <p>BE0705.917.993</p>
            </div>
          </div>
          ...
          <div className="border-t border-gray-300 pt-4 flex flex-row">
            <h3 className="text-lg font-regular mb-2 md:mr-5 mr-5 mt-1" style={{ fontFamily: "Inter" }}>
              Follow Us
            </h3>

            <div className="flex space-x-3">
              {[LuFacebook, FaInstagram, LuLinkedin, LuTwitter].map((Icon, idx) => (
                <a
                  key={idx}
                  href="#"
